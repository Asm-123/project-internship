        ...
        <div className="w-[608px] h-[734px] relative">
          ...
          <div>
            <img
              src={Vector}
              alt=""
              className="relative w-5 h-5 left-[173px] top-[225px] flex-col justify-start items-start inline-flex"
            />
            ...
            <div>
              <img
                src={icon}
                alt=""
                className=" left-[222px] top-[230px] relative w-[16.67px] h-[16.67px] flex-col justify-start items-start inline-flex"
              />
              <span className=" relative left-[225px] top-[230px] w-[117px] h-5 text-white text-sm font-normal font-bodyFont">
                +20 101111111111
              </span>
            </div>
            <img
          ...
          <div className="  flex  top-[310px]  relative w-[100px] h-5 text-neutral-200 text-opacity-50 text-sm font-extralight  justify-start items-start font-bodyFont">
